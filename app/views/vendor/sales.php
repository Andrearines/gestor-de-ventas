    ...
    <div class="pos-main">
        ...
        <header class="pos-header">
            ...
            <div class="header-search">
                <div class="search-input-wrapper">
                    ...
                    <input type="text" placeholder="Buscar combo o producto..." id="product-search">
                </div>
            </div>
        </header>
        ...
        <div class="categories-bar">
            ...
            <button class="category-btn">
                <i class="fa-solid fa-burger"></i> Combos
            </button>
            <button class="category-btn">
                <i class="fa-solid fa-mug-hot"></i> Bebidas
            </button>
            <button class="category-btn">
                <i class="fa-solid fa-utensils"></i> Snaks
            </button>
        </div>
        ...
        <div class="products-grid custom-scrollbar">
            <?php foreach ($combos as $combo): ?>
                <div class="product-card"
                    onclick="addToCart(<?php echo $combo['id']; ?>, '<?php echo $combo['nombre']; ?>', <?php echo $combo['precio']; ?>)">
                    <div class="product-image"
                        ...
                        <?php if ($combo['stock'] < 20): ?>
                            <span class="badge-promo">¡Pocas unidades!</span>
                        <?php endif; ?>
                    </div>
                    <div class="product-details">
                        <h3 class="product-title"><?php echo $combo['nombre']; ?></h3>
                        <p class="product-desc">
                            <?php echo $combo['descripcion'] ?? 'Incluye hamburguesa, papas y refresco grande.'; ?></p>
    ...
    <aside class="pos-sidebar">
        ...
        <div style="padding: 1.5rem; border-bottom: 1px solid #f3f4f6;">
            <label
                ...
                a Boleto</label>
            <select
                style="width: 100%; padding: 0.75rem; border: 1px solid #e5e7eb; border-radius: 0.75rem; font-weight: 700; font-size: 14px;">
                <option value="">Seleccionar boleto físico...</option>
