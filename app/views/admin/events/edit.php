<?php
// Vista de editar evento (Reutilizando el diseño de create.php)
?>
<div class="create-event-container">
    ...
    <div class="create-event-header">
        <div class="header-title">
            ...
            <div>
                <h1>Editar Evento</h1>
                <p>Actualiza la información del evento benéfico</p>
            </div>
        </div>
    </div>
    ...
    <form id="eventForm" class="event-form" onsubmit="handleSubmit(event)">
        ...
        <div class="form-section">
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    <label for="precio_boleto">Boleto por persona *</label>
                    <div class="input-group">
                        <span class="input-prefix">$</span>
                        <input type="number" id="precio_boleto" name="precio_boleto"
                            value="<?php echo $event['boleto-por-persona'] ?? ''; ?>" min="0" step="0.01"
